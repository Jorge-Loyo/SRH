...
|---|---|---|---|
| CPH | Ejecución Planta | `CPH-PL-{seq}` | CPH-PL-000001 |
| CPH | Ejecución Guardia | `CPH-GU-{seq}` | CPH-GU-000001 |
| CPH | Jefe Planta | `CPH-J-PL-{seq}` | CPH-J-PL-000001 |
| CPH | Jefe Guardia | `CPH-J-GU-{seq}` | CPH-J-GU-000001 |
...
| EG | Director | `EG-D-{seq}` | EG-D-000001 |
| EG | Carrera Gerencial | `EG-CG-{seq}` | EG-CG-000001 |
...
- EG-J, EG-D y EG-CG solo por estructura
