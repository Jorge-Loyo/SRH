...
// -----------------------------------------------------------
function NavItem({ to, label, icon, exact = false, onNavigate }) {
  return (
    <NavLink
      to={to}
      end={exact}
...
// -----------------------------------------------------------
// Sidebar principal
// En pantallas `lg` y superiores se ve como columna fija de siempre.
// Por debajo de `lg` se comporta como drawer: oculto fuera de pantalla,
// se desliza con `open` y se cierra al tocar el fondo o al navegar.
// -----------------------------------------------------------
export default function Sidebar({ open = false, onClose = () => {} }) {
  ...
  return (
    <>
      {/* Fondo semitransparente — solo mobile/tablet, mientras el drawer está abierto */}
      <div
        onClick={onClose}
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 shrink-0 flex flex-col bg-white border-r border-gray-200
