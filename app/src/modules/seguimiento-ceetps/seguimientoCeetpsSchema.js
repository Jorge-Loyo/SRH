...
const seguimientoCeetssPaginationSchema = z.object({
  ...
  fecha_caratulacion_desde: z.string().optional(),
  fecha_caratulacion_hasta: z.string().optional(),
  ...
  numero_apto_medico:       z.string().optional(),
  fecha_proyecto_dispo_desde: z.string().optional(),
  fecha_proyecto_dispo_hasta: z.string().optional(),
  dispo_designacion:        z.string().optional(),
  resolucion_designacion:   z.string().optional(),
  id_cargo:                 z.string().optional(),
  // Baja
